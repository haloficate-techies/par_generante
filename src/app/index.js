import {
  ...
  FOOTBALL_SCORES_BACKGROUND_LOOKUP as FOOTBALL_SCORES_BACKGROUND_LOOKUP_RAW,
  BIG_MATCH_BACKGROUND_LOOKUP as BIG_MATCH_BACKGROUND_LOOKUP_RAW,
} from "../domains/brand";
...
export * from "./config/modules/mode/mode.utils";
...
export const FOOTBALL_SCORES_BACKGROUND_LOOKUP = FOOTBALL_SCORES_BACKGROUND_LOOKUP_RAW || {};
export const BIG_MATCH_BACKGROUND_LOOKUP = BIG_MATCH_BACKGROUND_LOOKUP_RAW || {};
