...
import { resolveAutoTeamLogoSrc as resolveAutoTeamLogoSrcHelper } from "../domains/teams";
import { loadOptionalImage as loadOptionalImageHelper } from "../utils/image-loader";
import {
  DEFAULT_BRAND_PALETTE as FALLBACK_BRAND_PALETTE,
  deriveBrandPalette as deriveBrandPaletteHelper,
} from "../utils/color-utils";
import { createInitialMatches as createInitialMatchesHelper } from "../data/helpers/match-factory";
import {
...
export const DEFAULT_BRAND_PALETTE = FALLBACK_BRAND_PALETTE;
...
export const DEFAULT_ESPORT_MINI_BANNER =
  MODULES_DEFAULT_ESPORT_MINI_BANNER || ESPORT_MINI_BANNER_FOOTER || null;
...
export const createInitialMatches = createInitialMatchesHelper;
export const resolveAutoTeamLogoSrc = resolveAutoTeamLogoSrcHelper;
export const loadOptionalImage = loadOptionalImageHelper;
export const deriveBrandPalette = (image) =>
  (typeof deriveBrandPaletteHelper === "function"
    ? deriveBrandPaletteHelper(image)
    : DEFAULT_BRAND_PALETTE) || DEFAULT_BRAND_PALETTE;
