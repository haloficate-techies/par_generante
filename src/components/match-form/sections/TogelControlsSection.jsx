...
const TogelControlsSection = ({
  ...
  shouldShowDrawTimeSelector = false,
}) => {
...
const poolOptionShape = PropTypes.shape({
  label: PropTypes.string.isRequired,
  value: PropTypes.string.isRequired,
  modes: PropTypes.arrayOf(PropTypes.string),
});

const drawTimeConfigShape = PropTypes.shape({
  helperText: PropTypes.string,
  disabledReason: PropTypes.string,
});

TogelControlsSection.propTypes = {
  isTogelMode: PropTypes.bool,
  pools: PropTypes.arrayOf(poolOptionShape),
  selectedPool: PropTypes.string,
  onPoolChange: PropTypes.func,
  showVariantSelector: PropTypes.bool,
  poolVariants: PropTypes.arrayOf(PropTypes.string),
  selectedVariant: PropTypes.string,
  onVariantChange: PropTypes.func,
  selectedPoolOption: poolOptionShape,
  drawTimeConfig: drawTimeConfigShape,
  drawTimeOptions: PropTypes.arrayOf(PropTypes.string),
  togelDrawTime: PropTypes.string,
  onTogelDrawTimeChange: PropTypes.func,
  shouldShowDrawTimeSelector: PropTypes.bool,
};
