---
name: Refactor Large Components
overview: Memecah ImageUploadPreview (379 lines) dan MatchFieldset (370 lines) menjadi sub-komponen yang lebih kecil, modular, dan mudah di-maintain untuk meningkatkan code quality, testability, dan reusability.
todos:
  - id: create-hooks-folder
    content: Create hooks folder under match-form/ui
    status: completed
  - id: extract-useimageupload
    content: Extract useImageUpload custom hook
    status: completed
  - id: extract-imagepreviewdisplay
    content: Create ImagePreviewDisplay component
    status: completed
  - id: extract-imageadjustmentcontrols
    content: Create ImageAdjustmentControls component
    status: completed
  - id: extract-imageactionbuttons
    content: Create ImageActionButtons component
    status: completed
  - id: refactor-imageuploadpreview
    content: Refactor main ImageUploadPreview to use sub-components
    status: completed
  - id: extract-matchbasicinfo
    content: Create MatchBasicInfoInputs component
    status: completed
  - id: extract-matchscore
    content: Create MatchScoreInputs component
    status: completed
  - id: extract-matchlogos
    content: Create MatchLogosSection component
    status: completed
  - id: extract-matchesports
    content: Create MatchEsportsSection component
    status: completed
  - id: extract-matchplayers
    content: Create MatchPlayerImagesSection component
    status: completed
  - id: refactor-matchfieldset
    content: Refactor main MatchFieldset to use sub-components
    status: completed
  - id: update-barrel-exports
    content: Update barrel export files
    status: completed
  - id: validate-changes
    content: Run lint and tests to validate refactoring
    status: completed
---
